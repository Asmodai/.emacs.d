...
(defcustom folding-font-lock-begin-mark 'font-lock-comment-delimiter-face
  "Face to highlight beginning fold mark."
  :type  'face
  :group 'folding)

(defcustom folding-font-lock-end-mark 'font-lock-comment-delimiter-face
...
(folding-add-to-marks-list 'autoconf-mode          "dnl {{{" "dnl }}}" nil t)
...
(folding-add-to-marks-list 'objc-mode              "// {{{" "// }}}" nil t)
...
(folding-add-to-marks-list 'tex-mode               "%{{{"   "%}}}" nil t)
(folding-add-to-marks-list 'texinfo-mode   "@c {{{" "@c }}}" " }}}" t)
